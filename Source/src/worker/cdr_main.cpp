...
int main() try {
    ...
    options.build_id = std::string{vove::worker::kCdrWorkerBuildId};
    options.capabilities =
        ...
        vove::worker::capability_bit(vove::worker::Capability::cdr_handler);
    options.executor = vove::worker::execute_cdr_job_native;
#ifndef _WIN32

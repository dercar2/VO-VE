...
int main() try {
    ...
    options.build_id = std::string{vove::worker::kDocumentWorkerBuildId};
    options.capabilities =
        ...
        vove::worker::capability_bit(vove::worker::Capability::document_handler);
    options.executor = vove::worker::execute_document_job_native;
#ifndef _WIN32

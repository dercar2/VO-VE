...
if(NOT DEFINED SAMPLE OR NOT EXISTS "${SAMPLE}")
  message(FATAL_ERROR "HEIC smoke sample is missing: ${SAMPLE}")
endif()
...
set(local_sample "${smoke_directory}/vove-heic-decode-smoke.heic")
file(COPY_FILE "${SAMPLE}" "${local_sample}" ONLY_IF_DIFFERENT)
execute_process(
  COMMAND "${EXECUTABLE}" "vove-heic-decode-smoke.heic"
  WORKING_DIRECTORY "${smoke_directory}"
  RESULT_VARIABLE smoke_result)
file(REMOVE "${local_sample}")
if(NOT smoke_result EQUAL 0)
  message(FATAL_ERROR "HEIC decode contour smoke failed: ${smoke_result}")
endif()
